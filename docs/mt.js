...
const MainApp = {
    ...
    methods: {
            ...
            if (this.contractaddress) {
                try {
                    ...
                    if (accounts && accounts.length > 0) {
                        ...
                        let result = await contract.maxTokenId();
                        console.log(result);
                        this.maxTokenId = parseInt(result);
                    }
                } catch (err) {
        ...
        async uploadMeta(data) {
            ...
            let url = "https://ipfs.io/ipfs/" + json.value.cid + "/" + json.value.files[0].name;
            console.log("<<< uploadMeta");
            return url;
        },
        async getEvents() {
